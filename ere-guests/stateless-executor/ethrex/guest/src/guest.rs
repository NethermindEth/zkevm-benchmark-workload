...
/// Input for the Ethrex stateless executor guest program.
#[derive(Serialize, Deserialize, Archive)]
pub struct EthrexStatelessExecutorInput(pub ProgramInput);

impl Clone for EthrexStatelessExecutorInput {
    fn clone(&self) -> Self {
        Self(ProgramInput {
...
impl Debug for EthrexStatelessExecutorInput {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        f.debug_struct("EthrexStatelessExecutorInput")
...
pub type EthrexStatelessExecutorOutput = ([u8; 32], [u8; 32], bool);

/// [`Guest`] implementation for Ethrex stateless executor.
#[derive(Debug, Clone)]
pub struct EthrexStatelessExecutorGuest;

impl Guest for EthrexStatelessExecutorGuest {
    type Io = IoRkyv<EthrexStatelessExecutorInput, EthrexStatelessExecutorOutput>;

    fn compute<P: Platform>(
        EthrexStatelessExecutorInput(input): <Self::Io as Io>::Input,
        ...
        let res = P::cycle_scope("execution", || execution_program(input));
